...
ActiveRecord::Schema[7.0].define(version: 2023_02_01_155914) do
  ...
  create_table "player_achievements", force: :cascade do |t|
    ...
    t.index ["game_id"], name: "index_player_achievements_on_game_id"
  ...
  add_foreign_key "player_achievements", "games"
